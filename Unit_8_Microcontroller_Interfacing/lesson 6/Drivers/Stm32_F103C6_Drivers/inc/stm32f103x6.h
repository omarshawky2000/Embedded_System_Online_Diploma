...
#define NVIC_IRQ31_I2C1_EV_EN()									(NVIC_ISER0 |= 1<<31)
#define NVIC_IRQ32_I2C1_ER_EN()									(NVIC_ISER1 |= 1<<0) //32-32
#define NVIC_IRQ33_I2C2_EV_EN()									(NVIC_ISER1 |= 1<<1) //33-32
#define NVIC_IRQ34_I2C2_ER_EN()									(NVIC_ISER1 |= 1<<2) //34-32

#define NVIC_IRQ35_SPI1_EN()									(NVIC_ISER1 |= 1<<3)  //35-32
#define NVIC_IRQ36_SPI2_EN()									(NVIC_ISER1 |= 1<<4)  //36-32
...
#define NVIC_IRQ31_I2C1_EV_DIS()									(NVIC_ICER0 = 1<<31)
#define NVIC_IRQ32_I2C1_ER_DIS()									(NVIC_ICER1 = 1<<0) //32-32
#define NVIC_IRQ33_I2C2_EV_DIS()									(NVIC_ICER1 = 1<<1) //33-32
#define NVIC_IRQ34_I2C2_ER_DIS()									(NVIC_ICER1 = 1<<2) //34-32

#define NVIC_IRQ35_SPI1_DIS()									(NVIC_ICER1 = 1<<3)  //35-32
#define NVIC_IRQ36_SPI2_DIS()									(NVIC_ICER1 = 1<<4)  //36-32
